$(document).ready(function(){
    ...
    function countBill(object){
        ...
        if (+pe1_1 < +pe1_2) {
            ...
            price1_1.html(pe1_1);
            $('.pr-vol-1').attr('href', '/basket/add/?productID=88&productCount=' + Math.ceil(pe1_1/14.2));
        } else {
            ...
            price1_2.html(pe1_2);
            $('.pr-vol-1').attr('href', '/basket/add/?productID=100&productCount=' + Math.ceil(pe1_1/1401.9));
        }
        /*-----------semena-2------------*/
        ...
        if (+pe2_3 < +pe2_2 && +pe2_3 < +pe2_1) {
            ...
            $('.pr-vol-2').attr('href', '/basket/add/?productID=94&productCount=' + Math.ceil(pe2_1/2591.3));
            ...
            $("#price-second-one").css({display:"none"});
            $('.pr-vol-2').attr('href', '/basket/add/?productID=99&productCount=' + Math.ceil(pe2_1/156.2));
            ...
            $("#price-second-three").css({display:"none"});
            $("#price-second-two").css({display:"none"});
            $('.pr-vol-2').attr('href', '/basket/add/?productID=89&productCount=' + Math.ceil(pe2_1/18.8));
        }
        /*-----------semena-3------------*/
        ...
        if (+pe3_3 < +pe3_2 && +pe3_3 < +pe3_1) {
            ...
            r_quantity3.html('x ' + Math.ceil(pe3_1/2484.4) + ' шт');
            price3_3.html(pe3_3);
            $("#price-three-three").css({display:"block"});
            $("#price-three-one").css({display:"none"});
            $("#price-three-two").css({display:"none"});
            $('.pr-vol-3').attr('href', '/basket/add/?productID=95&productCount=' + Math.ceil(pe3_1/2484.4));
        } else if (+pe3_2 < +pe3_1 && +pe3_2 < + pe3_3) {
            r_volume3.html('1кг');
            r_quantity3.html('x ' + Math.ceil(pe3_1/165) + ' шт');
            price3_2.html(pe3_2);
            $("#price-three-two").css({display:"block"});
            $("#price-three-one").css({display:"none"});
            $("#price-three-three").css({display:"none"});
            $('.pr-vol-3').attr('href', '/basket/add/?productID=97&productCount=' + Math.ceil(pe3_1/165));
        } else if (+pe3_1 < +pe3_2 && +pe3_1 < +pe3_3) {
            r_volume3.html('100 г');
            r_quantity3.html('x ' + Math.ceil(pe3_1/18.8) + ' шт');
            price3_1.html(pe3_1);
            $("#price-three-one").css({display:"block"});
            $("#price-three-two").css({display:"none"});
            $("#price-three-three").css({display:"none"});
            $('.pr-vol-3').attr('href', '/basket/add/?productID=90&productCount=' + Math.ceil(pe3_1/18.8));
        }
        /*-----------semena-4------------*/
        ...
        if (+pe4_3 < +pe4_2 && +pe4_3 < +pe4_1) {
            ...
            r_quantity4.html('x ' + Math.ceil(pe4_1/2538.8) + ' шт');
            price4_3.html(pe4_3);
            $("#price-four-one").css({display:"none"});
            $("#price-four-two").css({display:"none"});
            $("#price-four-three").css({display:"block"});
            $('.pr-vol-4').attr('href', '/basket/add/?productID=87&productCount=' + Math.ceil(pe4_1/2538.8));
        } else if (+pe4_2 < +pe4_1 && +pe4_2 < + pe4_3) {
            r_volume4.html('1кг');
            r_quantity4.html('x ' + Math.ceil(pe4_1/128.4) + ' шт');
            price4_2.html(pe4_2);
            $("#price-four-one").css({display:"none"});
            $("#price-four-two").css({display:"block"});
            $("#price-four-three").css({display:"none"});
            $('.pr-vol-4').attr('href', '/basket/add/?productID=85&productCount=' + Math.ceil(pe4_1/128.4));
        } else if (+pe4_1 < +pe4_2 && +pe4_1 < +pe4_3) {
            r_volume4.html('100 г');
            r_quantity4.html('x ' + Math.ceil(pe4_1/18.8) + ' шт');
            price4_1.html(pe4_1);
            $("#price-four-one").css({display:"block"});
            $("#price-four-two").css({display:"none"});
            $("#price-four-three").css({display:"none"});
            $('.pr-vol-4').attr('href', '/basket/add/?productID=87&productCount=' + Math.ceil(pe4_1/18.8));
        ...
        if (+pe5_3 < +pe5_2 && +pe5_3 < +pe5_1) {
            ...
            r_quantity5.html('x ' + Math.ceil(pe5_1/2591.3) + ' шт');
            price5_3.html(pe5_3);
            $("#price-five-one").css({display:"none"});
            $("#price-five-two").css({display:"none"});
            $("#price-five-three").css({display:"block"});
            $('.pr-vol-5').attr('href', '/basket/add/?productID=96&productCount=' + Math.ceil(pe5_1/2591.3));
        } else if (+pe5_2 < +pe5_1 && +pe5_2 < + pe5_3) {
            r_volume5.html('1кг');
            r_quantity5.html('x ' + Math.ceil(pe5_1/157.5) + ' шт');
            price5_2.html(pe5_2);
            $("#price-five-one").css({display:"none"});
            $("#price-five-two").css({display:"block"});
            $("#price-five-three").css({display:"none"});
            $('.pr-vol-5').attr('href', '/basket/add/?productID=98&productCount=' + Math.ceil(pe5_1/157.5));
        } else if (+pe5_1 < +pe5_2 && +pe5_1 < +pe5_3) {
            r_volume5.html('100 г');
            r_quantity5.html('x ' + Math.ceil(pe5_1/18.8) + ' шт');
            price5_1.html(pe5_1);
            $("#price-five-one").css({display:"block"});
            $("#price-five-two").css({display:"none"});
            $("#price-five-three").css({display:"none"});
            $('.pr-vol-5').attr('href', '/basket/add/?productID=91&productCount=' + Math.ceil(pe5_1/18.8));
        }
        /*-----------semena-6------------*/
        ...
        if (+pe6_3 < +pe6_2 && +pe6_3 < +pe6_1) {
            ...
            r_quantity6.html('x ' + Math.ceil(pe6_1/2748.8) + ' шт');
            price6_3.html(pe6_3);
            $("#price-six-one").css({display:"none"});
            $("#price-six-two").css({display:"none"});
            $("#price-six-three").css({display:"block"});
            $('.pr-vol-6').attr('href', '/basket/add/?productID=54&productCount=' + Math.ceil(pe6_1/2748.8));
        } else if (+pe6_2 < +pe6_1 && +pe6_2 < + pe6_3) {
            r_volume6.html('1кг');
            r_quantity6.html('x ' + Math.ceil(pe6_1/166.3) + ' шт');
            price6_2.html(pe6_2);
            $("#price-six-one").css({display:"none"});
            $("#price-six-two").css({display:"block"});
            $("#price-six-three").css({display:"none"});
            $('.pr-vol-6').attr('href', '/basket/add/?productID=53&productCount=' + Math.ceil(pe6_1/166.3));
        } else if (+pe6_1 < +pe6_2 && +pe6_1 < +pe6_3) {
            r_volume6.html('100 г');
            r_quantity6.html('x ' + Math.ceil(pe6_1/18.8) + ' шт');
            price6_1.html(pe6_1);
            $("#price-six-one").css({display:"block"});
            $("#price-six-two").css({display:"none"});
            $("#price-six-three").css({display:"none"});
            $('.pr-vol-6').attr('href', '/basket/add/?productID=52&productCount=' + Math.ceil(pe6_1/18.8));
        }
        /*-----------semena-7------------*/
        ...
        if (+pe7_4 < +pe7_3 && +pe7_4 < +pe7_2 && +pe7_4 < +pe7_1) {
            ...
            $('.pr-vol-7').attr('href', '/basket/add/?productID=86&productCount=' + Math.ceil(pe7_1/7933.1));
            ...
            $('.pr-vol-7').attr('href', '/basket/add/?productID=2790&productCount=' + Math.ceil(pe7_1/4800));
            ...
            $("#price-seven-three").css({display:"none"});
            $("#price-seven-four").css({display:"none"});
            $('.pr-vol-7').attr('href', '/basket/add/?productID=2789&productCount=' + Math.ceil(pe7_1/495));
            ...
            $("#price-seven-three").css({display:"none"});
            $("#price-seven-four").css({display:"none"});
            $('.pr-vol-7').attr('href', '/basket/add/?productID=92&productCount=' + Math.ceil(pe7_1/30));
        }
        /*-----------end-semena------------*/
