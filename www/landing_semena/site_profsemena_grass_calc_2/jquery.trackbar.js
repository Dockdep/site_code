	...
	init : function(hash) {
		try {
			...
			this.jq.html('<table' + (this.width ? ' style="width:'+this.width+'px;"' : '') + 'class="trackbar" onSelectStart="return false;">\
				<tr>\
					<td class="l"><div id="leftBlock"><span></span><img id="leftBegun" ondragstart="return false;" src="imgtrackbar/b_l.png" width="20" height="18" alt="" /></div></td>\
					<td class="c" id="centerBlock"></td>\
					<td class="r"><div id="rightBlock"><span></span><img id="rightBegun" ondragstart="return false;" src="imgtrackbar/b_r.png" width="9" height="18" alt="" /></div></td>\
				</tr>\
			</table>');
			// Is all right?
			if (this.onMove == null) {
