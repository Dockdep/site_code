        ...
        <div class="registrated_customer clearfix<?= empty( $message ) ? ' display_none' : '' ?>">
            <div class="clearfix">
                <div class="float login_with login_with_email">
                    <form id="customer_login_from_order_<?= ($lang_id == 1 ? 'ua' : 'ru') ?>" method="post">
                        ...
                        <div class="submit clearfix">
                            ...
                            <a href="<?= $this->url->get([ 'for' => 'restore_passwd' ]) ?>" class="float float_right"><?= $t->_("forgot_your_password") ?></a>
                        </div>
                        <div class="submit clearfix">
                            <a href="<?= $this->url->get([ 'for' => 'registration' ]) ?>" class="float float_right do_registration"><?= $t->_("create_an_account") ?></a>
                        </div>
                    </form>
                </div>
                ...
                <div class="float login_with login_with_social last">
                    <div class="clearfix">
                        <p class="login_with_social_title"><?= $t_("login_via_social_network") ?></p>
