...
<div class="breadcrumbs">
    <div class="inner">
        ...
        <ul class="clearfix">
            ...
            <li  itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="" class="float"><a itemprop="url" href="<?=$this->seoUrl->setUrl('/video') ?>" title="<?= $t->_("video") ?>" class="breadcrumbs_last"><span itemprop="title"><?= $t->_("video") ?></span></a></li>
        </ul>
    </div>
</div>
