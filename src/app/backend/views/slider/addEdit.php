        ...
        <div class="sidebar_content_wrapper clearfix">
            ...
            <div class="content_wrapper float">
                <div class="content_wrapper_list clearfix">
                    <div class="table_name header_gradient">Банеры</div>
                    ...
                    <div class="table_pages_wrapper">
                        <form method="post" enctype="multipart/form-data" action="" id="news_add_edit">
                            ...
                            <div class="version_1 clearfix">
                                ...
                                <div class="clearfix input_wrapper">
                                    <div class="label"><label for="weight_1">Вес</label></div>
                                    <div class="input"><input type="text" name="weight_1" id="weight_1" value='<?=  (isset( $page['1']['weight'] ) && !empty( $page['1']['weight'] ) ? $page['1']['weight'] : '') ?>'></div>
                                </div>
                                <div class="clearfix input_wrapper">
                            ...
                            <div class="version_2 clearfix display_none">
                                ...
                                <div class="clearfix input_wrapper">
                                    <div class="label"><label for="weight_2">Вес</label></div>
                                    <div class="input"><input type="text" name="weight_2" id="weight_2" value='<?=  (isset( $page['2']['weight'] ) && !empty( $page['2']['weight'] ) ? $page['2']['weight'] : '') ?>'></div>
                                </div>
                            ...
                            <div class="clearfix submit_wrapper">
                                <a href="<?= $this->url->get([ 'for' => 'slider_index' ]) ?>" class="news_cancel float">Отмена</a>
