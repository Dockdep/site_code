...
<div class="breadcrumbs">
    <div class="inner">
        ...
        <ul class="clearfix">
            ...
            <li  itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="" class="float"><a  itemprop="url"  href="<?= $this->seoUrl->setUrl('/prof_tips')?>" title="Поради професіоналів"><span itemprop="title">Поради професіоналів</span></a></li>
            <li class="float more"><img src="/images/breadcrumbs_arrow.png" alt="" height="7" width="7" /></li>
            <?= '<li  itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="" class="float"><a  itemprop="url" href="'.$this->seoUrl->setUrl($one_news['link']).'" title="'.$one_news['title'].'" class="breadcrumbs_last"><span itemprop="title">'.$one_news['title'].'</span></a></li>' ?>
        </ul>
    </div>
</div>

<div class="news_wrapper">
    <div class="inner clearfix" itemscope itemtype="http://schema.org/Article">

        <h1 itemprop="name"><?= $one_news['title'] ?></h1>
        <?php
            ...
            $data_one_news .=
                '<div class="news_img_holder">'.
                    '<a href="'.$this->storage->getPhotoUrl( $one_news['cover'], 'news', '800x' ).'" title="'.$one_news['title'].' data-options="thumbnail: \''.$this->storage->getPhotoUrl( $one_news['cover'], 'news', '180x120' ).'\'"  class="thumbnail news_cover">'.
                        '<img itemprop="image" src="'.$one_news['image'].'" alt="'.$one_news['title'].'" width="400" height="265">'.
                    '</a>';
        ...
        echo( $data_one_news );
		echo '<p itemprop="datePublished">'.date("d-m-Y", strtotime($one_news['publish_date'])).'</p>';
        ...
        <div class="news_content">
            <p><span itemprop="description"><?= $one_news['content'] ?></span></p>
