...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        (
            ...
            ->setName( 'banner_index' );



        $router->add
        (
            '/banner_index/page/{page:[0-9]+}',
            [
                'controller'    => 'banner',
                'action'        => 'index',
            ]
        )
            ->setName( 'banner_index_paged' );
        ...
        $router->add
        (
            '/banner_delete/{id:[0-9]+}',
            [
                'controller'    => 'banner',
                'action'        => 'delete',
            ]
        )
            ->setName( 'banner_delete' );
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $router->add
        (
            '/modal_index/page/{page:[0-9]+}',
            [
                'controller'    => 'modal',
                'action'        => 'index',
            ]
        )
            ->setName( 'modal_index_paged' );
        ...
        $router->add
            (
                '/special_users_index',
                [
                    'controller' => 'special_users',
                    'action' => 'index'
                ]
            )
            ->setName('special_users_index');

        $router->add
            (
                '/special_users_index/page/{page:[0-9]+}',
                [
                    'controller' => 'special_users',
                    'action' => 'index'
                ]
            )
            ->setName('special_users_index_paged');
        ...
        $router->add
            ...
            ->setName('special_users_add');

        $router->add
            (
                '/special_users_delete/{id:[0-9]+}',
                [
                    'controller' => 'special_users',
                    'action' => 'delete'
                ]
            )
            ->setName('special_users_delete');

        $router->add
            (
                '/special_users_update/{id:[0-9]+}',
                [
                    'controller' => 'special_users',
                    'action' => 'update'
                ]
            )
            ->setName('special_users_update');

        $router->add
        (
            '/customer_ideas',
            [
                'controller' => 'customer_ideas',
                'action' => 'index'
            ]
        )
            ->setName('customer_ideas_index');

        $router->add
        (
            '/customer_ideas_index/page/{page:[0-9]+}',
            [
                'controller' => 'customer_ideas',
                'action' => 'index'
            ]
        )
            ->setName('customer_ideas_index_paged');
        ...
        (
            ...
            ->setName('customer_ideas_add');

        $router->add
        (
            '/customer_ideas_delete/{id:[0-9]+}',
            [
                'controller' => 'customer_ideas',
                'action' => 'delete'
            ]
        )
            ->setName('customer_ideas_delete');

        $router->add
        (
            '/customer_ideas_update/{id:[0-9]+}',
            [
                'controller' => 'customer_ideas',
                'action' => 'update'
            ]
        )
            ->setName('customer_ideas_update');
        ...
        (
            ...
            ->setName('actions_index');

        $router->add
        (
            '/actions_index/page/{page:[0-9]+}',
            [
                'controller' => 'actions',
                'action' => 'index'
            ]
        )
            ->setName('actions_index_paged');
        ...
        $router->add
        (
            '/actions_delete/{id:[0-9]+}',
            [
                'controller' => 'actions',
                'action' => 'delete'
            ]
        )
            ->setName('actions_delete');

        $router->add
        (
            '/actions_update/{id:[0-9]+}',
            [
                'controller' => 'actions',
                'action' => 'update'
            ]
        )
            ->setName('actions_update');


        $router->add
        (
            '/action_discount_index',
            [
                'controller' => 'action_discount',
                'action' => 'index'
            ]
        )
            ->setName('action_discount_index');

        $router->add
        (
            '/action_discount_index/page/{page:[0-9]+}',
            [
                'controller' => 'action_discount',
                'action' => 'index'
            ]
        )
            ->setName('action_discount_index_paged');
        ...
        (
            ...
            ->setName('action_discount_add');

        $router->add
        (
            '/action_discount_delete/{id:[0-9]+}',
            [
                'controller' => 'action_discount',
                'action' => 'delete'
            ]
        )
            ->setName('action_discount_delete');

        $router->add
        (
            '/action_discount_update/{id:[0-9]+}',
            [
                'controller' => 'action_discount',
                'action' => 'update'
            ]
        )
            ->setName('action_discount_update');
        ...
        (
            ...
            ->setName('promo_codes_index');

        $router->add
        (
            '/promo_codes_index/page/{page:[0-9]+}',
            [
                'controller' => 'promo_codes',
                'action' => 'index'
            ]
        )
            ->setName('promo_codes_index_paged');
        ...
        (
            ...
            ->setName('promo_codes_add');

        $router->add
        (
            '/promo_codes_delete/{id:[0-9]+}',
            [
                'controller' => 'promo_codes',
                'action' => 'delete'
            ]
        )
            ->setName('promo_codes_delete');

        $router->add
        (
            '/promo_codes_update/{id:[0-9]+}',
            [
                'controller' => 'promo_codes',
                'action' => 'update'
            ]
        )
            ->setName('promo_codes_update');

        $router->add
        (
            '/get_filters_by_catalog',
            [
                'controller' => 'promo_codes',
                'action' => 'getFiltersByCatalog'
            ]
        )
            ->setName('get_filters_by_catalog');
        ...
        (
            ...
            [
                'controller' => 'promo_codes',
                'action' => 'getItemsByFilter'
            ]
        )
            ->setName('get_items_by_filter');
        ...
        $router->add
        (
            '/sales_index/page/{page:[0-9]+}',
            [
                'controller' => 'sales',
                'action' => 'index'
            ]
        )
            ->setName('sales_index_paged');
        ...
        (
            ...
            ->setName('reviews_index');

        $router->add
        (
            '/reviews_index/page/{page:[0-9]+}',
            [
                'controller' => 'reviews',
                'action' => 'index'
            ]
        )
            ->setName('reviews_index_paged');
        ...
        $router->add
        (
            '/reviews_delete/{id:[0-9]+}',
            [
                'controller' => 'reviews',
                'action' => 'delete'
            ]
        )
            ->setName('reviews_delete');

        $router->add
        (
            '/reviews_update/{id:[0-9]+}',
            [
                'controller' => 'reviews',
                'action' => 'update'
            ]
        )
            ->setName('reviews_update');
	...
	$router->add
        ...
        (
            ...
            ->setName( 'set_pdf_file' );
        $router->add
        (
            '/set_reconciliation',
            [
                'controller'    => 'seo',
                'action'        => 'setReconciliation',
            ]
        )
            ->setName( 'set_reconciliation' );
        ///////////////////////////////////////////////////////////////////////////////////////////////////////
