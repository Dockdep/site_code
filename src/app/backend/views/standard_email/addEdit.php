                        ...
                        <form enctype="multipart/form-data" method="post" action="" id="email_event_add_edit">
                            ...
                            <div class="clearfix input_wrapper">
                                <fieldset>
                                    ...
                                    <div class="clearfix input_wrapper">
                                        <input type="radio" id="send_method_to_all" class='send_method' name="send_method" checked="checked"/>
                                        <label for="send_method_to_all"><span></span>Отправить всем пользователям</label>

                                        <input type="radio" id="send_method_to_selected" class='send_method' name="send_method"/>
                                        <label for="send_method_to_selected"><span></span>Выбрать из списка</label>
                                    </div>
                                    ...
                                    <div class="clearfix input_wrapper" id="send_method_users_table">
                                        ...
                                        <div class="clearfix input_wrapper">
                                            ...
                                            <div class="label"><label for="autocomplete_user_email">Введите email пользователя</label></div>
                            ...
                            <div class="clearfix submit_wrapper">
                                <a href="<?= $this->url->get([ 'for' => 'standard_email_index' ]) ?>" class="news_cancel float">Отмена</a>
                                <input type="submit" class="news_submit float" name="save" value="Сохранить">
                                <input type="submit" class="news_submit float cancel" name="send" value="Отправить" onclick="return confirm('Подтвердите отправку рассылки')">
                            </div>
